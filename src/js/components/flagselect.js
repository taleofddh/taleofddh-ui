...
var _countries = require('../common/countries');
...
var FlagSelect = function (_Component) {
    _inherits(FlagSelect, _Component);

    function FlagSelect(props) {
        _classCallCheck(this, FlagSelect);
    ...
    FlagSelect.prototype.toggleOptions = function toggleOptions() {
        !this.state.disabled && this.setState({
            openOptions: !this.state.openOptions
        });
    };

    FlagSelect.prototype.toggleOptionsWithKeyboard = function toggleOptionsWithKeyboard(evt) {
        evt.preventDefault();
        if (evt.keyCode === 13) {
    ...
    FlagSelect.prototype.closeOptions = function closeOptions(event) {
    ...
    FlagSelect.prototype.onSelect = function onSelect(countryCode) {
        this.setState({
    ...
    FlagSelect.prototype.onSelectWithKeyboard = function onSelectWithKeyboard(evt, countryCode) {
        evt.preventDefault();
        if (evt.keyCode === 13) {
            //enter key: select
    ...
    FlagSelect.prototype.updateSelected = function updateSelected(countryCode) {
    ...
    FlagSelect.prototype.filterSearch = function filterSearch(evt) {
        var _this2 = this;
    ...
    FlagSelect.prototype.setCountries = function setCountries() {
        var _this3 = this;
    ...
    FlagSelect.prototype.componentDidMount = function componentDidMount() {
        this.setCountries();
        !this.props.disabled && window.addEventListener("click", this.closeOptions);
    };

    FlagSelect.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
        if (prevProps.countries !== this.props.countries || prevProps.blackList !== this.props.blackList) {
            this.setCountries();
        }
    };

    FlagSelect.prototype.componentWillUnmount = function componentWillUnmount() {
        !this.props.disabled && window.removeEventListener("click", this.closeOptions);
    };

    FlagSelect.prototype.render = function render() {
        var _this4 = this;
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { ref: 'selectedFlag', style: { fontSize: selectedSize + 'rem' }, className: 'selected--flag--option ' + (this.props.disabled ? 'no--focus' : ''), tabIndex: '0', onClick: this.toggleOptions, onKeyUp: function onKeyUp(evt) {
                ...
                _react2.default.createElement('img', { src: '/images/flags/' + isSelected + '.png', alt: isSelected }),
            ...
            'div',
            { ref: 'flagOptions', style: { fontSize: optionsSize + 'rem' }, className: 'flag-options ' + alignClass },
            ...
            (this.state.filter ? this.state.filteredCountries : this.state.countries).map(function (countryCode) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', { src: '/images/flags/' + countryCode + '.png' }),
...
FlagSelect.propTypes = process.env.NODE_ENV !== "production" ? {
