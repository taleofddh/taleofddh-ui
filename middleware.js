...
export const config = {
    matcher: [
         ...
         */
        //'/((?!about-us|blog|blogs|gallery|albums|link|travel-guide|contact-us|sign-in|sign-up|reset-password|change-password|terms-and-conditions|privacy-policy|frequently-asked-questions).*)'
    ]
}